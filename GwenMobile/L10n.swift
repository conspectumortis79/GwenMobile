...
enum L {
    ...
    static let strings: [String: [AppLanguage: String]] = [
        ...
        "thinking_depth": [.de: "Denktiefe", .en: "Thinking depth"],
        "thinking_default": [.de: "Standard des Modells", .en: "Model default"],
        "thinking_off": [.de: "Aus — schnellste Antwort", .en: "Off — fastest answer"],
        "thinking_minimal": [.de: "Minimal", .en: "Minimal"],
        "thinking_low": [.de: "Sparsam", .en: "Low"],
        "thinking_medium": [.de: "Ausgewogen", .en: "Medium"],
        "thinking_high": [.de: "Gründlich", .en: "High"],
        "thinking_xhigh": [.de: "Sehr gründlich", .en: "Extra high"],
        "thinking_max": [.de: "Maximal", .en: "Maximum"],
        "thinking_footer_probed": [.de: "Der Provider bestätigt %d Denk-Stufen für dein Chat-Modell.",
                                   .en: "Your provider confirms %d thinking levels for the chat model."],
        "thinking_footer_unknown": [.de: "Denk-Stufen dieses Modells noch nicht beim Provider erfragt — „Modelle vom Konto laden“ holt sie.",
                                    .en: "This model's thinking levels have not been requested yet — “Load models from account” fetches them."],
        "vision_footer_unprobed": [.de: "Welche Modelle Bilder sehen, wird beim Modell-Laden beim Provider geprüft.",
                                   .en: "Which models can see images is verified with the provider while loading models."],
        "vision_footer_count": [.de: "Die Vision-Liste zeigt nur die %d Modelle deines Kontos mit bestätigter Bild-Eingabe.",
                                .en: "The vision list shows only your %d account models with confirmed image input."],
        "vision_footer_none": [.de: "Kein Modell deines Kontos nimmt Bild-Eingabe an — deshalb kann die Vision-Auswahl leer sein.",
                               .en: "No model in your account accepts image input — the vision selection can therefore be empty."],
        ...
        "picture_out_of_memory": [.de: "Das genannte Bild liegt zu lange zurück — %@ ältere Bilder sind nicht mehr im Zugriff, weil immer nur die letzten vier Bilder einer Unterhaltung mitreisen. Schicke das Bild bitte noch einmal mit.",
                                  .en: "That picture is too far back in this chat — %@ older pictures are out of reach, because only the last four pictures of a conversation travel along. Please send that picture again."],
        ...
        "open_image": [.de: "Bild öffnen", .en: "Open image"],
        "close_image": [.de: "Bild schließen", .en: "Close image"],
        "previous_picture": [.de: "Vorheriges Bild", .en: "Previous picture"],
        "next_picture": [.de: "Nächstes Bild", .en: "Next picture"],
        ...
        "cal_calendar": [.de: "🗓 Kalender: %@", .en: "🗓 Calendar: %@"],
        "cal_calendar_missing": [.de: "Einen Kalender \"%@\" gibt es nicht — zur Auswahl: %@",
                                 .en: "There is no calendar called \"%@\" — you can pick: %@"],
        "cal_no_calendar": [.de: "Kein beschreibbarer Kalender gefunden — alle deine Kalender sind schreibgeschützt.",
                            .en: "No writable calendar found — every calendar you have is read-only."],
        ...
        "web_chart_prompt": [.de: "Diagramm-Protokoll: Will der Nutzer Zahlen, Statistiken oder Verläufe als Diagramm, Grafik, Chart oder Visualisierung sehen, antworte nicht mit Text, sondern ausschließlich mit [[CHART]] und nichts sonst. Soll die Grafik auf Daten aus dem Internet beruhen, antworte ausschließlich mit [[SEARCH]][[CHART]] in genau dieser Reihenfolge — die App holt dann die Daten und gibt sie an das Bildmodell weiter; in diesem Fall sende beide Tokens statt nur [[SEARCH]]. Will er nur nachschlagen, nimm nur [[SEARCH]]. Beispiele für [[CHART]]: „stell die Zahlen als Diagramm dar“, „mach eine Grafik über die Umsatzentwicklung“, „zeit die Temperaturen als Liniendiagramm“. Beispiele für [[SEARCH]][[CHART]]: „such im Internet nach den Einwohnerzahlen und stell sie als Diagramm dar“, „hold die aktuellen Arbeitslosenquoten und zeig sie als Grafik“. Will er nur nachschlagen, nimm nur [[SEARCH]] — Beispiele: „wie hoch ist die Einwohnerzahl?“, „such nach den neuesten Zahlen“. Will er kein Diagramm („kein Diagramm“, „nur als Text“) oder stellt er eine normale Frage ohne Wunsch nach einer Grafik, antworte normal in Text und benutze niemals einen Token. Soll er ein vorhandenes Bild oder Diagramm nur erklärt, abgelesen, nach seinen Zahlen oder Quellen befragt oder bewertet bekommen, antworte ebenfalls in Text — [[CHART]] erzeugt immer eine neue Grafik und ist nie die Antwort auf eine Frage zu einer bereits gezeigten Grafik.",
                             .en: "Chart protocol: when the user wants numbers, statistics or trends shown as a diagram, chart, graph or visualisation, do not answer in text — reply with exactly [[CHART]] and nothing else. If the chart should rest on data from the internet, reply with exactly [[SEARCH]][[CHART]] in that order — the app then gathers the data and passes it to the image model. This overrides the rule above about sending only [[SEARCH]]. Examples for [[CHART]]: “show the numbers as a diagram”, “make a chart of the revenue trend”, “plot the temperatures”. Examples for [[SEARCH]][[CHART]]: “look up the population figures online and chart them”, “get the latest unemployment rates and draw a graph”. If he only wants research, use [[SEARCH]] alone — e.g. “what is the population?”, “search for the newest figures”. If he does not want a chart (“no chart”, “just text”) or asks an ordinary question, answer in normal text and never use a token. If he only wants an existing picture or chart explained, read out, questioned about its numbers or its sources, or judged, answer in text as well — [[CHART]] always produces a brand new graphic and is never the answer to a question about a graphic that was already shown."],
        ...
        "making_chart": [.de: "Erzeuge Diagramm", .en: "Drawing the chart"],
        "memory_prompt": [.de: "Die App erinnert sich an die Unterhaltung: deine vorige Antwort, die Frage dazu und die Bilder der letzten Runde werden dir erneut mitgegeben, wenn sie für die neue Frage nötig sind. Ein mitgeschicktes Bild kannst du also sehen — auch eines, das du selbst erzeugt hast. Beziehe dich darauf, statt nach einem Bild zu fragen, das du nicht siehst. Wenn mehrere Bilder mitkommen, sind sie in zeitlicher Reihenfolge durchnummeriert: Bild 1 ist das älteste Bild dieser Auswahl, das letzte Bild ist das neueste. Fragt der Nutzer ohne Nummer nach einem Bild, meint er das neueste — also das letzte Bild der Auswahl.",
                          .en: "The app remembers the conversation: your previous answer, the question it answered and the pictures of the last round are attached again whenever the new question needs them. A picture that comes along is visible to you — including one you generated yourself. Work with it instead of asking for an image you cannot see. When several pictures come along, they are numbered in chronological order: image 1 is the oldest of this selection and the last image is the newest. When the user asks about a picture without naming a number, they mean the newest one — the last image of the selection."],
        "chart_no_data": [.de: "Keine verwertbaren Zahlen in den Quellen gefunden — bitte Eingrenzung oder Quelle nennen.",
                          .en: "No usable numbers in the sources — please narrow the request or name a source."],
        "chart_data_line": [.de: "Daten:", .en: "Data:"],
        ...
        "edit_frame_multi": [.de: "Das erste Bild ist das Zielbild: bearbeite ausschließlich dieses Bild. Jedes weitere Bild ist nur Vorlage für Farben, Stil, Größe oder Details und darf unverändert bleiben. Übernimm keine Bildkanten, Objekte oder Bildteile der Vorlage in das Zielbild, nur die genannte Eigenschaft. Das Ergebnis zeigt genau ein Objekt: das Zielbild allein, keine Collage, kein Bild-im-Bild, kein zweites Objekt. Gib ausschließlich das bearbeitete Zielbild zurück, kein unbearbeitetes Vorlagenbild. Anfrage: %@",
                             .en: "The first image is the target: edit that image only. Every further image is a template for colours, style, size or detail and must stay unchanged. Do not copy borders, objects or parts of the template into the target image, take only the property that is named. The result shows exactly one object: the target image alone, no collage, no picture-in-picture, no second object. Return only the edited target image, never an untouched template image. Request: %@"],
        ...
        "save_as_file": [.de: "Als Datei sichern", .en: "Save as file"],
        "send_via_airdrop": [.de: "Per AirDrop senden", .en: "Send via AirDrop"],
        "image_gone": [.de: "✖ Bild ist nicht mehr im Speicher — bitte erneut erzeugen lassen.",
                          .en: "✖ Image is no longer stored — please ask for it again."],
        "answers_saved": [.de: "✔ Gesichert in Dateien → GwenMobile → answers", .en: "✔ Saved in Files → On My iPhone → GwenMobile → answers"],
        "export_unavailable": [.de: "Die Ablage konnte nicht geöffnet werden — bitte erneut versuchen.", .en: "Could not open the share sheet — please try again."],
